...
if [ ! -f "recuitVoyageur_translation" ]; then
...
COUTS_FILE="couts_optimaux_translationalphamoinsT.txt"
...
EOF
    ...
    ./recuitVoyageur_translation < input_params.txt > temp_output.txt 2>&1
...
for t_alpha in 0.85 0.50 0.25 0.1 0.01; do
